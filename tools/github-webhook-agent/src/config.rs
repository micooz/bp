...
const TEMP_DIR: &str = "/tmp/github-webhook-agent";
const TEMP_SCRIPT_PATH: &str = "/tmp/github-webhook-agent/run.sh";
...
impl Rule {
    ...
    pub fn run(&self, ctx: Context) -> Result<String> {
        ...
        let script = format!(
            "# This file is automatically @generated by github-webhook-agent.\n# It is not intended for manual editing.\n\n{}",
            cmd_list.join("\n")
        );
